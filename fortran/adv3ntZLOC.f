...
!  IF(GLOBAL.AND.I1P.GT.NXP)I1P=1
  ...
  if (i1p > size(s,1) .or. j1p > size(s,2)) then
     write (*,*) 'subroutine adv3ntZLOC: i1p and/or j1p exceeds allowable limit:', &
...
!dwen(20090810)  XF=XF-FLOAT(I1)
!dwen(20090810)  YF=YF-FLOAT(J1)
  ZF=ZF-FLOAT(K1)
!dwen(20090810) ****************
      IF (ZF > TINY(ZF)) STOP 'adv3ntZLOC: vertical interpolation not allowed. STOP.'
!dwen ***************************

! value at x1 along bottom of lowest layer
!dwen(20090810)  SB=(S(I1P,J1 ,K1)-S(I1,J1 ,K1))*XF+S(I1,J1 ,K1)
! value at x1 along top of lowest layer
!dwen(20090810)  ST=(S(I1P,J1P,K1)-S(I1,J1P,K1))*XF+S(I1,J1P,K1)
! value at x1,y1 of lowest layer
!dwen(20090810)  SS=(ST-SB)*YF+SB
    SS = S(I1,J1  ,K1)

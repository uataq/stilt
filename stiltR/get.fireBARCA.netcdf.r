get.fireBARCA.netcdf<-function(fdate,i,j,ires,jres,spec="co2"){
...
if(!any(names(getLoadedDLLs())=="getfireBARCAnetCDF"))dyn.load(paste(shlibpath,"getfireBARCAnetCDF.so",sep=""))
#print("log")
...
res <- .Fortran('getfireBARCAnetCDF',

...
shlibpath <- "/Net/Groups/BSY/STILT/repository_export/stiltR/shlib"   # R extensions
...
gridtag <- "stilthr"       # sp resol. 1/8 x 1/12 deg, domain 12w35e-35n62n
if(gridtag == "stilt11" ){
...
##
ftintr  <-   1            # interval for footprint integration
